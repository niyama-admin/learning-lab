...
>
> **Why it is here:** bidirectional pretraining and task adaptation. Read after the preceding items in the roadmap.

## One-picture map

```mermaid
flowchart LR
  A["unlabelled text"] --> B["mask words"]
  B["mask words"] --> C["BERT encoder"]
  C["BERT encoder"] --> D["reusable representations"]
  D["reusable representations"] --> E["task head"]
```
