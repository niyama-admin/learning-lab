...
>
> **Why it is here:** software-team roles and structured handoffs. Read after the preceding items in the roadmap.

## One-picture map

```mermaid
flowchart LR
  A["requirement"] --> B["product spec"]
  B["product spec"] --> C["design"]
  C["design"] --> D["code"]
  D["code"] --> E["tests"]
  E["tests"] --> F["review"]
```
...
MetaGPT imitates a small software company: product, design, coding, and testing roles pass documents to one another.
...
Use typed artifacts and acceptance criteria at handoffs; version prompts and outputs; compare the role pipeline with simpler workflows on quality, latency, and cost.
...
Study standard operating procedures as coordination priors, information loss at interfaces, error propagation, organizational analogies, and benchmark external validity.
